...
public class Application2 {
    public static void main(String[] args) {
        ...
        if(yearSalary >= 50000000) bonusRate = 0.05;
        else if(yearSalary >= 30000000) bonusRate = 0.03;
        else if(yearSalary >= 10000000) bonusRate = 0.01;
        else bonusRate = 0;

        int bonus = (int)(yearSalary * bonusRate);
        int sumMonthSalary = monthSalary + bonus;
        ...
        System.out.println("============");
        System.out.println("총 급여 " + sumMonthSalary);
